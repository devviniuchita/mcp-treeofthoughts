...
# Try to import from fastmcp, fallback to local compatibility layer
try:
    ...
    # Fallback to local compatibility layer (4 levels up from providers/)
    from ....utilities.auth import parse_scopes
    from ....utilities.logging import get_logger
    from ....utilities.types import NotSet
    from ....utilities.types import NotSetT
    from ..auth_shim import AccessToken
    from ..auth_shim import TokenVerifier
